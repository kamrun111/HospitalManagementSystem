...
namespace HIMS.BLL
{
	public class PatientRefferedDoctorsBLL
	{
        ...
        public int ReffDoctorUpdate(PatientRefferedDoctors patientRefferedDoctors)//sami
        {
            try
            {
                return patient_reffered_doctorsDAL.ReffDoctorUpdate(patientRefferedDoctors);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int ReffDoctorAdd(PatientRefferedDoctors patientRefferedDoctors)//sami
        {
            try
            {
                return patient_reffered_doctorsDAL.ReffDoctorAdd(patientRefferedDoctors);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int Addpatient_reffered_doctors_icu(PatientRefferedDoctors opatient_reffered_doctors)
        {
            try
            {
                return patient_reffered_doctorsDAL.Addpatient_reffered_doctors_icu(opatient_reffered_doctors);
            }
            catch (Exception ex)
            {
                throw ex;
