...
namespace HIMS.BLL
{
	public class RefferedDoctorsBLL
	{
        ...
        public DataSet DoctorLoad()
        {
            try
            {
                return reffered_doctorsDAL.DoctorLoad();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet getconsultant()
        {
            try
            {
                return reffered_doctorsDAL.getconsultant();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet DoctorSepecific(string DoctorName)
        {
            try
            {
                return reffered_doctorsDAL.DoctorSepecific(DoctorName);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet getspecilist(int specialistInID)
        {
            try
            {
                return reffered_doctorsDAL.getspecilist(specialistInID);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet GetConsultantAllwithPatient()
        {
            try
            {
                return reffered_doctorsDAL.GetConsultantAllwithPatient();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int doctor_nameadd(RefferedDoctors refferedDoctors)
        {
            try
            {
                return reffered_doctorsDAL.doctor_nameadd(refferedDoctors);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int doctor_nameupdate(RefferedDoctors refferedDoctors)
        {
            try
            {
                return reffered_doctorsDAL.doctor_nameupdate(refferedDoctors);
            }
            catch (Exception ex)
            {
                throw ex;
