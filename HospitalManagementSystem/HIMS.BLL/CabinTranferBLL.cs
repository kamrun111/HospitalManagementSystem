...
namespace HIMS.BLL
{
	public class CabinTranferBLL
	{
        ...
        public DataSet GetCabinTransferPopulationInfoICU(int patient_code, string cabin)
        {
            try
            {
                return cabin_tranferDAL.GetCabinTransferPopulationInfoICU(patient_code, cabin);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet GetNonOccupiedCabinInfoICU()
        {
            try
            {
                return cabin_tranferDAL.GetNonOccupiedCabinInfoICU();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int Addcabin_tranferICU(CabinTranfer ocabin_tranfer)
        {
            try
            {
                return cabin_tranferDAL.Addcabin_tranferICU(ocabin_tranfer);
            }
            catch (Exception ex)
            {
                throw ex;
