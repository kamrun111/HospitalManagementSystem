...
namespace HIMS.BusinessObjects
{
	...
	public class InvestigationOrder
	{
        ...
        public InvestigationOrder(int investigation_order_id, Nullable<int> investigation_id, string order_no,Nullable<Decimal> total_amount,Nullable<int> test_department_id,Nullable<int> admission_id, Nullable<Decimal> discount, Nullable<DateTime> record_created_date, Nullable<int> record_created_by, Nullable<DateTime> record_modified_date, Nullable<int> record_modified_by)
		{
		...
		{
            return "investigation_order_id = " + investigation_order_id.ToString() + ",investigation_id = " + investigation_id.ToString() + ",order_no=" + order_no + ",total_amount=" + total_amount.ToString() + ",discount=" + discount.ToString() + ",test_department_id= " + test_department_id.ToString() + ", record_created_date = " + record_created_date.ToString() + ",record_created_by = " + record_created_by.ToString() + ",record_modified_date = " + record_modified_date.ToString() + ",record_modified_by = " + record_modified_by.ToString();
		}
