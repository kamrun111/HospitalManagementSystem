...
namespace HIMS.BusinessObjects
{
	...
	public class PatientOtherItem
	{
        ...
        public PatientOtherItem(int patient_other_item_id, Nullable<int> admission_id, Nullable<int> patient_id, Nullable<int> other_item_id,Nullable<decimal> unit_rate,  Nullable<DateTime> issue_date, Nullable<DateTime> return_date, Nullable<Decimal> consume_qty, Nullable<Decimal> qty_per_unit,Nullable<Decimal>discount, Nullable<DateTime> record_created_date, Nullable<int> record_created_by, Nullable<DateTime> record_modified_date, Nullable<int> record_modified_by)
		{
		...
		{
            return "patient_other_item_id = " + patient_other_item_id.ToString() + ",admission_id = " + admission_id.ToString() + ",patient_id=" + patient_id.ToString() + ",other_item_id = " + other_item_id.ToString() + ",unit_rate =" + unit_rate.ToString()+", issue_date = " + issue_date.ToString() + ",return_date = " + return_date.ToString() + ",consume_qty = " + consume_qty.ToString() + ",qty_per_unit = " + qty_per_unit.ToString() + ",discount=" + discount.ToString() + ", record_created_date = " + record_created_date.ToString() + ",record_created_by = " + record_created_by.ToString() + ",record_modified_date = " + record_modified_date.ToString() + ",record_modified_by = " + record_modified_by.ToString();
		}
