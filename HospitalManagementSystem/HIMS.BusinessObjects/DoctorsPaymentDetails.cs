...
namespace HIMS.BusinessObjects
{
    ...
    public class DoctorsPaymentDetails
    {
        ...
        private Nullable<int> _doctors_bill_id;

        public Nullable<int> doctors_bill_id
        {
        ...
        private Nullable<DateTime> _bill_submit_date;

        public Nullable<DateTime> bill_submit_date
        {
            get { return _bill_submit_date; }
            set { _bill_submit_date = value; }
        }
        ...
        public DoctorsPaymentDetails(int doctors_payment_details_id, int doctors_payment_id, int doctors_bill_id,int qty, int surgery_charge, int visit_qty, int visit_charge, int reducevisit_qty, int reducevisit_charge, int anestheia_charge, int assistance_charge, decimal total_amount, string flag, Nullable<int> record_created_by, Nullable<DateTime> record_created_date, Nullable<int> record_modified_by, Nullable<DateTime> record_modified_date)
		{
