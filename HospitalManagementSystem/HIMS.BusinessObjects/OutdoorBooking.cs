...
namespace HIMS.BusinessObjects
{
	...
	public class Outdoor_booking
	{
		...
		private string _reffered_doctors_id;

        public string reffered_doctors_id
		{
