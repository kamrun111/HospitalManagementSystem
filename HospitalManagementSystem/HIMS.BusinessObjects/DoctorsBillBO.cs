...
namespace HIMS.BusinessObjects
{
    ...
    public class DoctorsBillBO
    {
        ...
        private Nullable<int> _doctorbill_type_id;

        public Nullable<int> doctorbill_type_id
        {
            get { return _doctorbill_type_id; }
            set { _doctorbill_type_id = value; }
        }
        ...
        public DoctorsBillBO(int doctors_bill_id, Nullable<int> admission_id, Nullable<int> reffered_doctors_id,Nullable<int> doctorbill_type_id, Nullable<int> qty, decimal amount,decimal discount,Nullable<decimal> vat,int is_visit, int is_paid, Nullable<DateTime> paid_date, Nullable<DateTime> record_created_date, Nullable<int> record_created_by, Nullable<DateTime> record_modified_date, Nullable<int> record_modified_by)
        {
            this.doctors_bill_id = doctors_bill_id;
            this.admission_id = admission_id;
            this.reffered_doctors_id = reffered_doctors_id;
            this.doctorbill_type_id = doctorbill_type_id;
            this.qty = qty;
            this.amount = amount;
        ...
        {
            return "doctors_bill_id = " + doctors_bill_id.ToString() + ",admission_id = " + admission_id.ToString() + ",doctorbill_type_id =" + doctorbill_type_id.ToString() + ",qty=" + qty.ToString() + ", paid_date = " + paid_date.ToString() + ",reffered_doctors_id = " + reffered_doctors_id.ToString() + ",is_visit = " + is_visit.ToString() + ",is_paid = " + is_paid.ToString() + ",amount = " + amount.ToString() + ",discount=" + discount.ToString() + ",vat=" + vat.ToString() + ", record_created_date = " + record_created_date.ToString() + ",record_created_by = " + record_created_by.ToString() + ",record_modified_date = " + record_modified_date.ToString() + ",record_modified_by = " + record_modified_by.ToString();
        }
