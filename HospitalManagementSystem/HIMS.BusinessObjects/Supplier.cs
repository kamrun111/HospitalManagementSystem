...
namespace HIMS.BusinessObjects
{
	...
	public class Supplier
	{
		...
		public Supplier(int supplier_id,string supplier_name,string contact_person,string contact_no,string fax_no,string address,int supplier_type,Nullable<DateTime> record_created_date,Nullable<int> record_created_by,Nullable<DateTime> record_modified_date,Nullable<int> record_modified_by)
		{
		...
		{
            return "supplier_id = " + supplier_id.ToString() + ",supplier_name = " + supplier_name + ",contact_person = " + contact_person + ",contact_no = " + contact_no + ",fax_no = " + fax_no + ",address = " + address + ",supplier_type = " + supplier_type.ToString() + ",record_created_date = " + record_created_date.ToString() + ",record_created_by = " + record_created_by.ToString() + ",record_modified_date = " + record_modified_date.ToString() + ",record_modified_by = " + record_modified_by.ToString();
		}
