...
namespace HIMS.BusinessObjects
{
	...
	public class RequisitionProduct
	{
		...
		public RequisitionProduct(int requisition_product_id,Nullable<int> requisition_id,Nullable<int> product_id, string barcode,Nullable<decimal> unit_price,  Nullable<int> order_qty,Nullable<int> receive_qty,Nullable<int> refund_qty,Nullable<int> store_id,Nullable<DateTime> record_created_date,Nullable<int> record_created_by,Nullable<DateTime> record_modified_date,Nullable<int> record_modified_by)
		{
