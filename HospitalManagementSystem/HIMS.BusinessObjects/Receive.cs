...
namespace HIMS.BusinessObjects
{
	...
	public class Receive
	{
		...
		public Receive(int receive_id,string barcode,Nullable<int> purchase_id,string invoice_no,Nullable<DateTime> invoice_date,Nullable<DateTime> received_date,Nullable<int> store_id,Nullable<DateTime> record_created_date,Nullable<int> record_created_by,Nullable<DateTime> record_modified_date,Nullable<int> record_modified_by)
		{
		...
		{
			return "receive_id = " + receive_id.ToString() + ",barcode = " + barcode + ",purchase_id = " + purchase_id.ToString() + ",invoice_no = " + invoice_no + ",invoice_date = " + invoice_date.ToString() + ",received_date = " + received_date.ToString() + ",store_id = " + store_id.ToString() + ",record_created_date = " + record_created_date.ToString() + ",record_created_by = " + record_created_by.ToString() + ",record_modified_date = " + record_modified_date.ToString() + ",record_modified_by = " + record_modified_by.ToString();
		}

		public class receive_idComparer : System.Collections.Generic.IComparer<Receive>
		{
			...
			int System.Collections.Generic.IComparer<Receive>.Compare(Receive x, Receive y)
			{
		...
		public class barcodeComparer : System.Collections.Generic.IComparer<Receive>
		{
			public SorterMode SorterMode;
		...
		public class invoice_noComparer : System.Collections.Generic.IComparer<Receive>
		{
			public SorterMode SorterMode;
