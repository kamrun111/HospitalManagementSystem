...
namespace HIMS.BusinessObjects
{
    ...
    public class BillBO
    {
        ...
        public BillBO(int bill_id, Nullable<int> admission_id, Nullable<decimal> admission_fee, Nullable<decimal> investigation_fee, Nullable<decimal> treatment_fee, Nullable<decimal> ot_fee, Nullable<Decimal> post_operative_fee, Nullable<decimal> other_fee, Nullable<decimal> medicine_fee, Nullable<decimal> room_rent, Nullable<decimal> cabin_service_charge, Nullable<Decimal> loan, Nullable<decimal> vat, Nullable<decimal> doctors_fee, Nullable<decimal> discount, string remarks, Nullable<decimal> paid_amount, Nullable<DateTime> bill_generate_date, Nullable<DateTime> record_created_date, Nullable<int> record_created_by, Nullable<DateTime> record_modified_date, Nullable<int> record_modified_by)
        {
        ...
        {
            return "bill_id = " + bill_id.ToString() + ",admission_id = " + admission_id.ToString() + ",admission_fee = " + admission_fee.ToString() + ",investigation_fee = " + investigation_fee.ToString() + ",treatment_fee = " + treatment_fee.ToString() + ",ot_fee = " + ot_fee.ToString() + ",post_operative_fee=" + post_operative_fee.ToString() + ",other_fee= " + other_fee.ToString() + ",medicine_fee= " + medicine_fee.ToString() + ",room_rent= " + room_rent.ToString() + ",cabin_service_charge="+cabin_service_charge.ToString() + ", loan=" + loan.ToString() + ",vat = " + vat.ToString() + ",doctors_fee=" + doctors_fee.ToString() + ",discount=" + discount.ToString() + ",remarks=" + remarks.ToString() + ",paid_amount=" + paid_amount.ToString() + ",bill_generate_date=" + bill_generate_date.ToString() + ",record_created_date = " + record_created_date.ToString() + ",record_created_by = " + record_created_by.ToString() + ",record_modified_date = " + record_modified_date.ToString() + ",record_modified_by = " + record_modified_by.ToString();
        }
