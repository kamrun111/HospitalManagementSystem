	...
	public class InvestigationTestDAL
	{
        ...
        public int Updateinvestigation_testAfterReportDone(InvestigationTest oinvestigation_test)
        {
            ...
            {   
                ...
                arParams[2] = new SqlParameter("@record_created_by", oinvestigation_test.record_created_by);
                arParams[3] = new SqlParameter("@record_modified_by", oinvestigation_test.record_modified_by);
                arParams[4] = new SqlParameter("@investigation_test_id", oinvestigation_test.investigation_test_id);
        ...
        public int Updateinvestigation_test(InvestigationTest oinvestigation_test)
        {
            ...
            try
            {
                arParams[0] = new SqlParameter("@record_created_by", oinvestigation_test.record_created_by);
                arParams[1] = new SqlParameter("@record_modified_by", oinvestigation_test.record_modified_by);
                arParams[2] = new SqlParameter("@investigation_test_id", oinvestigation_test.investigation_test_id);
                return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, "investigation_testUpdate", arParams);
            }
            catch (Exception ex)
            {
