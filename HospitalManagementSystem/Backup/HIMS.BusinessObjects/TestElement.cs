...
namespace HIMS.BusinessObjects
{
	...
	public class TestElement
	{
        ...
        public TestElement(int test_element_id, string test_element, Nullable<int> test_item_id, Nullable<Decimal> charge, string reference_value, Nullable<DateTime> record_created_date, Nullable<int> record_created_by, Nullable<DateTime> record_modified_date, Nullable<int> record_modified_by)
		{
