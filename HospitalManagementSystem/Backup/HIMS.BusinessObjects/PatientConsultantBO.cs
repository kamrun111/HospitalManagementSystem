...
namespace HIMS.BusinessObjects
{
    ...
    public class PatientConsultantBO
    {
        ...
        public PatientConsultantBO(int patient_consultant_id, int patient_id, int case_no,Nullable<DateTime> record_created_date, Nullable<int> record_created_by, Nullable<DateTime> record_modified_date, Nullable<int> record_modified_by)
		{
