...
namespace HIMS.BusinessObjects
{
	...
	public class InvestigationBO
	{
		...
		public InvestigationBO(int investigation_id,Nullable<int> admission_id,Nullable<int> patient_id,Nullable<DateTime> order_date,Nullable<DateTime> record_created_date,Nullable<int> record_created_by,Nullable<DateTime> record_modified_date,Nullable<int> record_modified_by)
		{
