...
namespace HIMS.BusinessObjects
{
	...
	public class TestItem
	{
		...
		public TestItem(int test_item_id,string unit,string test_item,Nullable<int> test_group_id,Nullable<int> specimen_id,Nullable<Decimal> charge,string reference_value,Nullable<DateTime> record_created_date,Nullable<int> record_created_by,Nullable<DateTime> record_modified_date,Nullable<int> record_modified_by)
		{
		...
		{
			return "test_item_id = " + test_item_id.ToString() + ", unit=" + unit + ",test_item = " + test_item + ",test_group_id = " + test_group_id.ToString() + ",specimen_id="+specimen_id.ToString()+",charge = " + charge.ToString() + ",reference_value = " + reference_value + ",record_created_date = " + record_created_date.ToString() + ",record_created_by = " + record_created_by.ToString() + ",record_modified_date = " + record_modified_date.ToString() + ",record_modified_by = " + record_modified_by.ToString();
		}
