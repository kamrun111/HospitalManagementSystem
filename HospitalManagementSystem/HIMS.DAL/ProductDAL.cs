	...
	public class ProductDAL
	{
        ...
        public DataSet GetProductList(int producttypeID)
        {
            ...
            try
            {
                ...
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "GetProductList", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet GetProductCategory()
        {
            try
            {
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "GetProductCategory");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet GetProductforLedger()
        {
            try
            {
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "ProductLoadforLedger");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet ProductListforCategory(int Product_CategoryID)
        {
            ...
            try
            {
                arParams[0] = new SqlParameter("@product_category_id ", Product_CategoryID);
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "ProductListforCategory", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet reorderSearchproduct(int ProductcategoryID)
        {
            ...
            try
            {
                arParams[0] = new SqlParameter("@product_category_id", ProductcategoryID);
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "reorderSearchproduct", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet Searchproduct(int Product_CategoryID, string proName)
        {
            try
            {
                SqlParameter[] arParams = new SqlParameter[2];
                arParams[0] = new SqlParameter("@product_category_id", Product_CategoryID);
                arParams[1] = new SqlParameter("@product_name", proName);
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "Searchproduct", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet AllProductList(int ProductcatID, string Pname)
        {
            ...
            try
            {
                arParams[0] = new SqlParameter("@product_catID", ProductcatID);
                arParams[1] = new SqlParameter("@product_name", Pname);
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "AllProductList", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet reorderproduct(int ProductTypeID)
        {
            ...
            try
            {
                arParams[0] = new SqlParameter("@product_type_id", ProductTypeID);
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "reorderproduct", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int UpdateProducts(ProductBO oproduct)
        {
            ...
            try
            {
                ...
                arParams[7] = new SqlParameter("@product_id", oproduct.product_id);
                arParams[8] = new SqlParameter("@record_modified_by", oproduct.record_modified_by);
                arParams[9] = new SqlParameter("@consider_level", oproduct.consider_level);

                return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, "productUpdateMain", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet GetProductPopulationInfo()
        {
            try
            {
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "GetProductPopulationInfo");
