	...
	public class PatientDAL
	{
        ...
        public DataSet PatientHospatalIdSearch(int HospitalID)
        {
            try
            {
                ...
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "PatientHospatalIdSearch", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet HospitalIDSearchDiscountPatient(int HospitalID)
        {
            try
            {
                SqlParameter[] arParams = new SqlParameter[1];
                arParams[0] = new SqlParameter("@hospitalID", HospitalID);
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "HospitalIDSearchDiscountPatient", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int AddPatientAdmissionForDialysis(Patient patient, AdmissionBO admission, string GRID, string CityID, string OccupID, string NationID, string RelID, string GenderID, string PConID, out int paymentID, int Flag)
        {
            ...
            try
            {
                ...
                arParams[12] = new SqlParameter("@patient_condition", PConID);
                arParams[13] = new SqlParameter("@admission_date", admission.admission_date);
                arParams[14] = new SqlParameter("@deposit", admission.deposit);
                arParams[15] = new SqlParameter("@is_bill_clear", admission.is_bill_clear);
                arParams[16] = new SqlParameter("@record_created_by", admission.record_created_by);
                arParams[17] = new SqlParameter("@admission_id", admission.admission_id);
                arParams[18] = new SqlParameter("@payment_id", SqlDbType.Int, 11);
                arParams[19] = new SqlParameter("@flag", Flag);
                arParams[17].Direction = ParameterDirection.Output;
                arParams[18].Direction = ParameterDirection.Output;

                SqlHelper.ExecuteNonQuery(conn, CommandType.StoredProcedure, "PatientAdmissionAddForDialysis", arParams);
                result = Convert.ToInt32(arParams[17].Value.ToString());
                paymentID = Convert.ToInt32(arParams[18].Value.ToString());
            }
            catch (Exception ex)
            {
                result = -2;
        ...
        public int AddPatientAdmissionForICU(Patient patient, AdmissionBO admission, string GRID, string CityID, string OccupID, string NationID, string RelID, string GenderID, string PConID, out int paymentID, int Flag)
        {
            ...
            try
            {
                ...
                arParams[17].Direction = ParameterDirection.Output;
                arParams[18].Direction = ParameterDirection.Output;
                arParams[20] = new SqlParameter("@is_biscount_clear", admission.is_biscount_clear);
                arParams[21] = new SqlParameter("@cabin_id", admission.cabin_id);

                SqlHelper.ExecuteNonQuery(conn, CommandType.StoredProcedure, "PatientAdmissionAddForICU", arParams);
                result = Convert.ToInt32(arParams[17].Value.ToString());
                paymentID = Convert.ToInt32(arParams[18].Value.ToString());
            }
            catch (Exception ex)
        ...
        public int PatientAdmissionAddwithMember(Patient patient, AdmissionBO admission, string GRID, string CityID, string OccupID, string NationID, string RelID, string GenderID, string PConID, out int paymentID, int Flag)
        {
            ...
            try
            {
                ...
                arParams[25] = new SqlParameter("@payment_id", SqlDbType.Int, 11);
                arParams[26] = new SqlParameter("@flag", Flag);
                arParams[27] = new SqlParameter("@pt_type", admission.pt_type);
                arParams[24].Direction = ParameterDirection.Output;
                arParams[25].Direction = ParameterDirection.Output;

                SqlHelper.ExecuteNonQuery(conn, CommandType.StoredProcedure, "PatientAdmissionAddwithMember", arParams);
                result = Convert.ToInt32(arParams[24].Value.ToString());
                paymentID = Convert.ToInt32(arParams[25].Value.ToString());
            }
            catch (Exception ex)
        ...
        public int UpdatePatientForAdmission(Patient patient, string GRID, string CityID, string OccupID, string NationID, string RelID, string GenderID, string PConID)
        {
            ...
            try
            {
                ...
                arParams[15] = new SqlParameter("@record_modified_by", patient.record_modified_by);
                arParams[16] = new SqlParameter("@patient_id", patient.patient_id);
                return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, "PatientUpdateForAdmission", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int UpdatePatientForDialysis(Patient patient, int gurdian_relation, int city_id, int occupation_id, int nationality_id, int religion_id, int gender_id, int patient_condition)
        {
            ...
            try
            {
                ...
                arParams[2] = new SqlParameter("@patient_name", patient.patient_name);
                arParams[3] = new SqlParameter("@guardian_name", patient.guardian_name);
                arParams[4] = new SqlParameter("@guardian_relation", gurdian_relation);
                arParams[5] = new SqlParameter("@gender", gender_id);
                arParams[6] = new SqlParameter("@address", patient.address);
                arParams[7] = new SqlParameter("@city", city_id);
                arParams[8] = new SqlParameter("@c_phone", patient.c_phone);
                arParams[9] = new SqlParameter("@dob", patient.dob);
                arParams[10] = new SqlParameter("@occupation", occupation_id);
                arParams[11] = new SqlParameter("@nationality", nationality_id);
                arParams[12] = new SqlParameter("@religion", religion_id);
                arParams[13] = new SqlParameter("@patient_condition", patient_condition);
                arParams[14] = new SqlParameter("@record_modified_by", patient.record_modified_by);
                arParams[15] = new SqlParameter("@patient_id", patient.patient_id);
                return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, "PatientUpdateForDialysis", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int UpdatePatientForAdmissionNew(Patient patient, string GRID, string CityID, string OccupID, string NationID, string RelID, string GenderID, string PConID)
        {
            ...
            try
            {
                ...
                arParams[2] = new SqlParameter("@guardian_name", patient.guardian_name);
                arParams[3] = new SqlParameter("@guardian_relation", GRID);
                arParams[4] = new SqlParameter("@gender_id", GenderID); 
                arParams[5] = new SqlParameter("@address", patient.address);
                arParams[6] = new SqlParameter("@city_id", CityID); 
                arParams[7] = new SqlParameter("@c_phone", patient.c_phone); 
                arParams[8] = new SqlParameter("@dob", patient.dob);
                arParams[9] = new SqlParameter("@occupation_id", OccupID);
                arParams[10] = new SqlParameter("@nationality_id", NationID);
                arParams[11] = new SqlParameter("@religion_id", RelID); 
                arParams[12] = new SqlParameter("@patient_condition_id", PConID); 
                //arParams[14] = new SqlParameter("@record_created_by", patient.record_created_by);
                arParams[13] = new SqlParameter("@record_modified_by", patient.record_modified_by);
                arParams[14] = new SqlParameter("@patient_id", patient.patient_id);
                return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, "PatientUpdateForAdmissionNew", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
