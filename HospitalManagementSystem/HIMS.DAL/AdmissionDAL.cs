...
namespace HIMS.DAL
{
	public class AdmissionDAL
	{
        ...
        public DataSet getcasesummaryID(int casesummaryID)
        {
            ...
            {
                SqlParameter[] arParams = new SqlParameter[1];
                arParams[0] = new SqlParameter("@casesummaryID", casesummaryID);
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "getcasesummaryID", arParams);
        ...
        public DataSet getcasesummaryID_ICU(int casesummaryID)
        {
            try
            {
                SqlParameter[] arParams = new SqlParameter[1];
                arParams[0] = new SqlParameter("@casesummaryID", casesummaryID);
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "getcasesummaryID_ICU", arParams);
        ...
        public int AddadmissionDialysis(AdmissionBO oadmission, out int paymentID, int Flag)
        {
            ...
            try
            {
                ...
                arParams[3] = new SqlParameter("@deposit", oadmission.deposit);
                arParams[4] = new SqlParameter("@is_bill_clear", oadmission.is_bill_clear);

                arParams[5] = new SqlParameter("@record_created_by", oadmission.record_created_by);
                arParams[6] = new SqlParameter("@record_modified_by", oadmission.record_modified_by);
                arParams[7] = new SqlParameter("@admission_id", oadmission.admission_id);
                arParams[8] = new SqlParameter("@payment_id", SqlDbType.Int, 11);
                arParams[7].Direction = ParameterDirection.Output;
                arParams[8].Direction = ParameterDirection.Output;
                arParams[9] = new SqlParameter("@falg", Flag);

                SqlHelper.ExecuteNonQuery(conn, CommandType.StoredProcedure, "admissionAddDialysis", arParams);
                result = Convert.ToInt32(arParams[7].Value.ToString());
                paymentID = Convert.ToInt32(arParams[8].Value.ToString());
            }
            catch (Exception ex)
            {
                result = -2;
        ...
        public int admissionAddICU(AdmissionBO oadmission, out int paymentID, int Flag)
        {
            ...
            try
            {
                ...
                arParams[8].Direction = ParameterDirection.Output;
                arParams[9] = new SqlParameter("@falg", Flag);
                arParams[10] = new SqlParameter("@is_biscount_clear", oadmission.is_biscount_clear);
                arParams[11] = new SqlParameter("@cabin_id", oadmission.cabin_id);

                SqlHelper.ExecuteNonQuery(conn, CommandType.StoredProcedure, "admissionAddICU", arParams);
                result = Convert.ToInt32(arParams[7].Value.ToString());
                paymentID = Convert.ToInt32(arParams[8].Value.ToString());
            }
            catch (Exception ex)
        ...
        public int AddadmissionWithMember(AdmissionBO oadmission, out int paymentID, int Flag)
        {
            ...
            try
            {
                ...
                arParams[4] = new SqlParameter("@deposit", oadmission.deposit);
                arParams[5] = new SqlParameter("@remarks", oadmission.remarks);
                arParams[6] = new SqlParameter("@pt_type", oadmission.pt_type);
                ...
                arParams[13] = new SqlParameter("@record_created_by", oadmission.record_created_by);
                arParams[14] = new SqlParameter("@record_modified_by", oadmission.record_modified_by);
                arParams[15] = new SqlParameter("@admission_id", oadmission.admission_id);
                arParams[16] = new SqlParameter("@payment_id", SqlDbType.Int, 11);
                arParams[15].Direction = ParameterDirection.Output;
                arParams[16].Direction = ParameterDirection.Output;
                arParams[17] = new SqlParameter("@flag", Flag);

                SqlHelper.ExecuteNonQuery(conn, CommandType.StoredProcedure, "admissionAddwithMember", arParams);
                result = Convert.ToInt32(arParams[15].Value.ToString());
                paymentID = Convert.ToInt32(arParams[16].Value.ToString());
            }
            catch (Exception ex)
            {
                result = -2;
        ...
        public int SetDischargeInfo(int admissionID, string cabin, int userID)
        {
            SqlParameter[] arParams = new SqlParameter[3];
            try
            {
                ...
                arParams[2] = new SqlParameter("@record_modified_by", userID);
                return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, "SetDischargeInfo", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int SetDischargeInfoICU(int admissionID, string cabin, int userID)
        {
            SqlParameter[] arParams = new SqlParameter[3];
            try
            {
                ...
                arParams[1] = new SqlParameter("@cabin", cabin);
                arParams[2] = new SqlParameter("@record_modified_by", userID);
                return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, "SetDischargeInfoICU", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int AdmissionStatusUpdate(AdmissionBO admissionBO)
        {
            try
            {
                ...
                arParams[0] = new SqlParameter("@admission_id", admissionBO.admission_id);
                arParams[1] = new SqlParameter("@pt_type", admissionBO.pt_type);
                arParams[2] = new SqlParameter("@record_modified_by", admissionBO.record_modified_by);

                return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, "AdmissionStatusUpdate", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int InsuranceUpdate(AdmissionBO admissionBO)
        {
            try
            {
                ...
                arParams[0] = new SqlParameter("@admission_id", admissionBO.admission_id);
                arParams[1] = new SqlParameter("@insurance_type", admissionBO.insurance_type);
                arParams[2] = new SqlParameter("@record_modified_by", admissionBO.record_modified_by);

                return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, "InsurancePatientAssign", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
