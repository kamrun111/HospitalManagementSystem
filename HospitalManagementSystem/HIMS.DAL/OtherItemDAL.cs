...
namespace HIMS.DAL
{
	public class OtherItemDAL
	{
        ...
        public DataSet getotheritems()
        {
            try
            {
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "getotheritems");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet getunitrate(int other_item_id)
        {
            try
            {
                SqlParameter[] arParams = new SqlParameter[1];
                arParams[0] = new SqlParameter("@other_item_id", other_item_id);
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "getunitrate", arParams);
