...
namespace HIMS.DAL
{
	public class RefferedDoctorsDAL
	{
        ...
        public DataSet getconsultant()
        {
            try
            {
                
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "getconsultant");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet GetConsultantAllwithPatient()
        {
            try
            {
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "GetConsultantAllwithPatient");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet DoctorLoad()
        {
            try
            {
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "DoctorLoad");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet DoctorSepecific(string doctorName)
        {
            try
            {
                SqlParameter[] arParams = new SqlParameter[1];
                arParams[0] = new SqlParameter("@doctor_name", doctorName);
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "DoctorSepecific", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet getspecilist(int specialistInID)
        {
            try
            {
                SqlParameter[] arParams = new SqlParameter[1];
                arParams[0] = new SqlParameter("@specilist", specialistInID);
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "getspecilist", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int doctor_nameadd(RefferedDoctors oreffered_doctors)
        {
            SqlParameter[] arParams = new SqlParameter[4];
            try
            {
                arParams[0] = new SqlParameter("@reffered_doctors", oreffered_doctors.reffered_doctors);
                arParams[1] = new SqlParameter("@specialist_in_id", oreffered_doctors.specialist_in_id);
                arParams[2] = new SqlParameter("@record_created_by", oreffered_doctors.record_created_by);
                arParams[3] = new SqlParameter("@record_created_date", oreffered_doctors.record_created_date);
               

                return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, "doctor_nameadd", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public int doctor_nameupdate(RefferedDoctors oreffered_doctors)
        {
            SqlParameter[] arParams = new SqlParameter[4];
            try
            {
                arParams[0] = new SqlParameter("@reffered_doctors", oreffered_doctors.reffered_doctors);
                arParams[1] = new SqlParameter("@specialist_in_id", oreffered_doctors.specialist_in_id);
                arParams[2] = new SqlParameter("@record_modified_by", oreffered_doctors.record_modified_by);
                arParams[3] = new SqlParameter("@reffered_doctors_id", oreffered_doctors.reffered_doctors_id);

                return DbHelper.ExecuteNonQuery(CommandType.StoredProcedure, "doctor_nameupdate", arParams);
            }
            catch (Exception ex)
            {
                throw ex;
