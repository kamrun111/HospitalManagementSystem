...
namespace HIMS.DAL
{
	public class SupplierDAL
	{
		...
		public DataSet Getsuppliers(int ProductTypeID)
		{
			try
			{
                SqlParameter[] arParams = new SqlParameter[1];
                arParams[0] = new SqlParameter("@productTypeID", ProductTypeID);
                return DbHelper.GetDataSet(CommandType.StoredProcedure, "supplierGetAll", arParams);
			}
			catch (Exception ex)
			{
				throw ex;
        ...
        public DataSet AddSupplierAndGetAll(Supplier osupplier)
        {
            ...
            try
            {
                ...
                arParams[3] = new SqlParameter("@fax_no", osupplier.fax_no);
                arParams[4] = new SqlParameter("@address", osupplier.address);
                arParams[5] = new SqlParameter("@supplier_type", osupplier.supplier_type);
                arParams[6] = new SqlParameter("@record_created_by", osupplier.record_created_by);
                arParams[7] = new SqlParameter("@record_modified_by", osupplier.record_modified_by);
		...
		public DataSet UpdateSupplier(Supplier osupplier, int productTypeID )
		{
            DataSet ds = null;
			...
			try
			{
				...
				arParams[3] = new SqlParameter("@fax_no", osupplier.fax_no);
				arParams[4] = new SqlParameter("@address", osupplier.address);
                arParams[5] = new SqlParameter("@productTypeID", productTypeID);
				arParams[6] = new SqlParameter("@record_created_by", osupplier.record_created_by);
				arParams[7] = new SqlParameter("@record_modified_by", osupplier.record_modified_by);
				arParams[8] = new SqlParameter("@supplier_id", osupplier.supplier_id);
